...
public class CardPurchasePage {
    ...
    public void fillAndSendInfo(String card, String month, String year, String name, String cvv) {
        clearForm();
    ...
    public void approvedPayment(String card, String month, String year, String name, String cvv) {
        fillAndSendInfo(card, month, year, name, cvv);
        successNotification.shouldBe(visible, Duration.ofSeconds(15)).
                shouldHave(exactText("Успешно\n" + "Операция одобрена Банком."));
    }

    public void declinedPayment(String card, String month, String year, String name, String cvv) {
        fillAndSendInfo(card, month, year, name, cvv);
